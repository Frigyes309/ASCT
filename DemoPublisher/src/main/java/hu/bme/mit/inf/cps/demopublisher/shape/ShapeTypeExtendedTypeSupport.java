...
public class ShapeTypeExtendedTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    public long get_serialized_sample_max_size(java.lang.Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().get_serialized_sample_max_size(epd,false,final_encapsulation_id,currentAlignment);

        currentAlignment +=hu.bme.mit.inf.cps.demopublisher.shape.ShapeFillKindTypeSupport.get_instance().get_serialized_sample_max_size(
            epd,
            false,
            final_encapsulation_id,
            (currentAlignment));
    ...
    public long get_serialized_sample_min_size(java.lang.Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().get_serialized_sample_min_size(epd,false,final_encapsulation_id,currentAlignment);
        currentAlignment += hu.bme.mit.inf.cps.demopublisher.shape.ShapeFillKindTypeSupport.get_instance().get_serialized_sample_min_size(
            epd,
            false,
            final_encapsulation_id,
            (currentAlignment));
        ...
        java.lang.Object sample)
    {
        ...
        currentAlignment += hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().get_serialized_sample_size(
            epd, false, final_encapsulation_id, currentAlignment, sample);

        currentAlignment += hu.bme.mit.inf.cps.demopublisher.shape.ShapeFillKindTypeSupport.get_instance().get_serialized_sample_size(
            epd,
            false,
            final_encapsulation_id,
            (currentAlignment),
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().get_serialized_key_max_size(
            epd,
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(
            epd,
            false,final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
    ...
    boolean serialize_sample, java.lang.Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().serialize(epd,src,dst,false,final_encapsulation_id,serialize_sample,endpoint_plugin_qos);
            dst.inBaseClass = false;
            hu.bme.mit.inf.cps.demopublisher.shape.ShapeFillKindTypeSupport.get_instance().serialize(epd, typedSrc.fillKind, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (serialize_key) {
            ...
            ShapeTypeExtended typedSrc = (ShapeTypeExtended) src;    
            dst.inBaseClass = true;
            hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().serialize_key(
                epd, src, dst, false, final_encapsulation_id, true, endpoint_plugin_qos);
            dst.inBaseClass = false;
            dst.inBaseClass = false;
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                ShapeTypeExtended typedSrc = (ShapeTypeExtended) src;      
                dst.inBaseClass = true;
                hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().serialize_key_for_keyhash(
                    epd, src, dst, false, final_encapsulation_id, true, endpoint_plugin_qos);
                dst.inBaseClass = false;
                dst.inBaseClass = false;
            }
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().deserialize_sample(epd,dst,src,false,deserialize_sample,endpoint_plugin_qos);
            src.inBaseClass = false;
            try{
                typedDst.fillKind = (hu.bme.mit.inf.cps.demopublisher.shape.ShapeFillKind)hu.bme.mit.inf.cps.demopublisher.shape.ShapeFillKindTypeSupport.get_instance().deserialize_sample(epd, typedDst.fillKind, src, false, true, endpoint_plugin_qos);     
    ...
    @java.lang.Override
    public ShapeTypeExtended data_from_string(
        java.lang.String string,
        PrintFormatKind kind)
    {
        return (ShapeTypeExtended) super.data_from_string(string, kind);
    }
    ...
    public ShapeTypeExtended data_from_string(
        java.lang.String string)
    {
        return (ShapeTypeExtended) super.data_from_string(string);
    }

    @java.lang.Override
    public ShapeTypeExtended data_from_dynamicdata(
        DynamicData dynamicData)
    {
        return (ShapeTypeExtended) super.data_from_dynamicdata(dynamicData);
    }
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_key) {
            ...
            src.inBaseClass = true;
            hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().deserialize_key_sample(
                epd, dst, src, false, true, endpoint_plugin_qos);
            src.inBaseClass = false;
    ...
    java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            src.inBaseClass = true;
            hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().skip(epd, src, false, true, endpoint_plugin_qos);
            src.inBaseClass = false;
            try {
                hu.bme.mit.inf.cps.demopublisher.shape.ShapeFillKindTypeSupport.get_instance().skip(epd, src, false, true, endpoint_plugin_qos);
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (deserialize_key) {
            ...
            src.inBaseClass = true;
            hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().serialized_sample_to_key(epd,sample,
            src,false, true,
            endpoint_plugin_qos);
            src.inBaseClass = false;
            try {
    ...
    */
    ...
    java.lang.Object key) {
        ...
        hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().key_to_instance(endpoint_data,instance,key);
    ...
    */
    ...
    java.lang.Object instance) {
        ...
        ShapeTypeExtended typedSrc
        = (ShapeTypeExtended) instance;
        hu.bme.mit.inf.cps.demopublisher.shape.ShapeTypeTypeSupport.get_instance().instance_to_key(endpoint_data,key,instance);
